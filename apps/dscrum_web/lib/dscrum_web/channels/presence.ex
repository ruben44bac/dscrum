defmodule DscrumWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule DscrumWeb.MyChannel do
        use DscrumWebWeb, :channel
        alias DscrumWebWeb.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :dscrum_web,
                        pubsub_server: DscrumWeb.PubSub
end
